...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>HideNSeek Mega Mod Menu V2</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                     "<p style=\"color:red;\">Modded by chr1s</p> | "
                                     "Im no longer going to add new stuff.</p>"
                                     "</marquee></b>"));
    ...
    //Toast Example
    Toast(env,ctx,OBFUSCATE("Modded by chr1s#4191, To ensure you're playing on the official mod, and not a tampered one, make sure you downloaded this Mod from platinmods.com!"),ToastLength::LENGTH_LONG);
    Toast(env,ctx,OBFUSCATE("Modded by chr1s#4191, To ensure you're playing on the official mod, and not a tampered one, make sure you downloaded this Mod from platinmods.com!"),ToastLength::LENGTH_LONG);
