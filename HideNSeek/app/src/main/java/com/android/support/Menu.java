...
public class Menu {
    ...
    int TEXT_COLOR_2 = Color.parseColor("#878686");
    int BTN_COLOR = Color.parseColor("#2E2E2E");
    int MENU_BG_COLOR = Color.parseColor("#00141414"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#00141414"); //#AARRGGBB
    int MENU_WIDTH = 290;
    int MENU_HEIGHT = 210;
    int POS_X = 0;
    int POS_Y = 100;
    ...
    int CategoryBG = Color.parseColor("#181818");
    int SeekBarColor = Color.parseColor("#00FF00");
    int SeekBarProgressColor = Color.parseColor("#00FF00");
