...
public class Menu {
    ...
    //region Variable
    public static final String TAG = "ModMenu"; //Tag for logcat

    int TEXT_COLOR = Color.parseColor("#F03535");
    int TEXT_COLOR_2 = Color.parseColor("#9E9E9E");
    int BTN_COLOR = Color.parseColor("#1C262D");
    int MENU_BG_COLOR = Color.parseColor("#FF1C1C1C"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#FF0F0F0F"); //#AARRGGBB
    int MENU_WIDTH = 290;
    int MENU_HEIGHT = 210;
    int POS_X = 0;
    int POS_Y = 100;
    ...
    int ToggleON = Color.RED;
    int ToggleOFF = Color.GRAY;
    int BtnON = Color.parseColor("#1b5e20");
    int BtnOFF = Color.parseColor("#7f0000");
    int CategoryBG = Color.parseColor("#363636");
    int SeekBarColor = Color.parseColor("#C95959");
    int SeekBarProgressColor = Color.parseColor("#C95959");
